...
ggplot2 is tidyverse's data visualization package that is made for create graphs of all types including bar graphs, scatterplots, line graphs, and maps. While it can create static and interactive maps and is rather easy to use because of its reliance on grammar of graphics, it isn't specifically made for maps so it can be a bit difficult to navigate and less customizable. Wrappers such as ggiraph(), ggplotly() and gganimate() can be used to build off of ggplot2's static maps to make interactive maps.
